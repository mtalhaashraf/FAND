...
<form on:submit={handleSubmit} class="flex flex-col gap-8 p-10 pl-8" novalidate>
  <div class="flex flex-row gap-1 text-[14px] leading-5 font-medium items-center">
    <span class="text-gray-3">Announcements</span>
  ...
  <div class="flex flex-row justify-between items-start w-full gap-20">
    <span class="text-[36px] font-semibold leading-8 w-full">Announcements</span>
  ...
  <div class="flex flex-col gap-10">
    <fieldset class="flex flex-col gap-8">
      <div class="flex flex-col gap-3">
        <label for="file-name" class="text-[16px] font-bold leading-5 text-gray-11">Title</label>
        <input name="file-name" type="text" class="py-2 px-3 text-gray-13 border-[1px] border-gray-2 rounded-lg appearance-none" id="file-name" value="" placeholder="Enter title here">
      </div>
      <div class="flex flex-col gap-3">
        <span for="description" class="text-[16px] font-bold leading-5 text-gray-11">Announcement Content</span>
        <div class="relative w-full">
          <textarea class="p-3 border-[1px] border-gray-2 w-full resize-none rounded-lg outline-none" name="" id="" cols="30" rows="10" placeholder="Enter announcement content"></textarea>
        </div>
      </div>
      <div class="flex flex-col gap-3">
        <label for="file-upload" class="text-[16px] font-bold leading-5 text-gray-11">Date</label>
        <input name="file-upload" type="date" class="py-2 px-3 text-gray-13 border-[1px] border-gray-2 rounded-lg appearance-none" id="file-name" value="" placeholder="Enter Upload">
      </div>
    </fieldset>
  </div>
</form>
...
<div id="cancel-modal" class="hidden absolute top-0 left-0 m-auto w-full h-screen bg-black-3 z-50">
  <div class="rounded-[12px] bg-white w-full max-w-[366px] h-fit flex flex-col gap-8 top-0 left-0 right-0 bottom-0 absolute m-auto p-6">
    ...
    <div class="flex flex-row gap-3 text-black font-semibold items-center w-full">
      ...
      <a href="/admin/athletes/browse" class="text-center rounded-lg py-[10px] px-5 w-full max-w-[152px] border-[1px] bg-yellow border-yellow">Confirm</a>
    </div>
  </div>
</div>
